...
func CreateReport(domainPrefix string) (*os.File, error) {
	...
	// File name will have the current time in unixtime.
...
// WriteReport aims to mimic the report generated by exporting Vend sales
// history.
func WriteReport(file *os.File, registers *[]vend.Register, users *[]vend.User,
	...
	for _, sale := range sales {
		...
		// Takes a Vend timestamp string as input and converts it to a Go Time.time
		// value.
