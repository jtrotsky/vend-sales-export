...
// SalesReport writes a mimic report of the one generated by
...
func SalesReport(registers *[]vend.Register, users *[]vend.User,
	...
	sales *[]vend.Sale, domainPrefix, timeZone string) error {
	...
	for _, sale := range *sales {
		...
		dtInLoc := vend.ParseVendDT(*sale.SaleDate, timeZone)
