...
// PadLeft returns the original string s padded on the left with a given string p to a total length of l
...
// PadRight returns the original string s padded on the right with a given string p to a total length of l
